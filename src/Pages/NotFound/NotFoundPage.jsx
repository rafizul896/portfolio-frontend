    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br bg-black">
      <div className="text-center space-y-8 p-8 max-w-md mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 px-6 py-3 bg-purple-700 text-white rounded-lg shadow-md hover:bg-purple-800 transition-colors duration-200 font-medium"
          >
            <Home size={20} />
            Return Home
          </Link>
